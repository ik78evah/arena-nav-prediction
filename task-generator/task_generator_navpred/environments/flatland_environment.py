...
class FlatlandEnvironment(BaseEnvironment):
    ...
    def spawn_random_dynamic_obstacle(self, obstacle_name, **args):
        self._spawn_random_obstacle(obstacle_name, **args, is_dynamic=True)

    def spawn_random_static_obstacle(self, obstacle_name, **args):
        self._spawn_random_obstacle(obstacle_name, **args, is_dynamic=False)
    ...
    def _spawn_random_obstacle(
        ...
        obstacle_name_generic = FlatlandEnvironment.create_obs_name(
